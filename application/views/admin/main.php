...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <div class='fb-customerchat'     
        page_id='104877775628581'     
        theme_color='#44bec7'     
        logged_in_greeting='Xin chào, chúng tôi có thể hổ trợ gì cho bạn không?'     
        logged_out_greeting='Xin chào, chúng tôi có thể hổ trợ gì cho bạn không?'>
    </div>
    ...
    <script type="text/javascript">
        ...
        (function(){
            ...
            s1.async=true;
            s1.src='https://embed.tawk.to/62cbc45bb0d10b6f3e7bb66c/1g7lve1kp';
            s1.charset='UTF-8';
